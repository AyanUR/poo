...
public SolarSis(){	 
	...
	Appearance appmarth = new Appearance();
	...
	Sphere marth = new Sphere(0.25f, Primitive.GENERATE_NORMALS | 
	Primitive.GENERATE_TEXTURE_COORDS, 32, appmarth);
	...
	TransformGroup marthRotXformGroup = rotate(marth, new Alpha(-1, 1250));
	TransformGroup earthTransXformGroup = translate(earthRotXformGroup, 
	new Vector3f(0.0f, 0.0f, 0.7f));
	TransformGroup marthTransXformGroup = translate(earthRotXformGroup, 
...
TransformGroup earthRotGroupXformGroup = rotate(earthTransXformGroup, new Alpha(-1, 5000));
		...
		group.addChild(marthRotXformGroup);
